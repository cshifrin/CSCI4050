...
<body>
    <div class="main-content">
        ...
        <p>Be sure to check for a confirmation email to view your receipt.</p>
        <button type="button" class="btn btn-outline-dark" onclick="window.location.href = 'userprofile.php';">Profile</button>
    </div>
</body>
